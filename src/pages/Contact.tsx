...
const contactStructuredData = {
  ...
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "Shriram colony Nainagardh road",
    "addressLocality": "Morena",
    "addressRegion": "Madhya Pradesh",
    "addressCountry": "IN"
  },
  "sameAs": [
    "https://www.linkedin.com/in/himanshu-sharma",
    "https://youtube.com/@my-pharmalens"
  ],
...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEOHead
        title="Contact Us - PharmaLens Support & Inquiries"
        description="Contact PharmaLens for support, feedback, or questions about our AI-powered medication identification app. Get help with pill identification, drug interactions, and medication lookup."
        keywords="contact pharmalens, medication app support, pill identifier help, drug information contact, pharmaceutical database support"
