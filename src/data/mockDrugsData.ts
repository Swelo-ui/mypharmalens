...
export const mockDrugsData: DrugData[] = [
  ...
  },
  {
    ...
    manufacturer: 'Various',
    category: 'Antihypertensive',
    description: 'Calcium channel blocker used to treat high blood pressure and certain types of chest pain (angina).',
    drugClass: 'Calcium channel blocker',
    verified: true,
  },
  {
    ...
    manufacturer: 'Various',
    category: 'Antihypertensive',
    description: 'Beta-blocker used to treat high blood pressure, irregular heart rhythms, and other heart or circulatory conditions.',
    drugClass: 'Beta blocker',
    verified: true,
  },
  {
