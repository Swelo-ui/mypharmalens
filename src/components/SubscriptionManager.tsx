            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {plans.map((plan) => {
                  ...
                  return (
                    <div key={plan.id} className="h-full">
                      <ShineBorder
                        ...
                        className="bg-white dark:bg-card p-0 h-full relative"
                      >
                        <Badge className="absolute -top-3 right-2 sm:right-4 bg-blue-500 text-xs z-20 shadow-sm border border-blue-400">
                          Active Plan
                        </Badge>
                ...
                return (
                  <Card
                    key={plan.id}
                    className="relative transition-all hover:shadow-md h-full"
                  >
                    {cardContent}
                  </Card>
                );
